...
class MahasiswaController extends BaseController
{
    public function index()
    {
        ...
        if ($role === 'mahasiswa') {
            ...
            $profilLengkap = !empty($mahasiswa['nama_perusahaan']) && !empty($mahasiswa['durasi_magang']);

            // Ambil broadcast 7 hari terakhir untuk mahasiswa
