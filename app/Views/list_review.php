...
<div class="container-fluid px-2">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2 w-100">
      <form method="get" action="<?= site_url('admin/review-kinerja') ?>" class="d-flex align-items-center me-2 flex-grow-1">
      ...
      <form method="get" action="<?= site_url('admin/review-kinerja') ?>" class="me-2">
      ...
      <div class="ms-auto">
      <a href="<?= site_url('admin/review-kinerja/export') ?>" class="btn btn-outline-success d-flex align-items-center">
              ...
              <?php foreach ($reviews as $index => $review): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?= base_url('admin/review-kinerja/detail/' . $review['review_id']) ?>" 
