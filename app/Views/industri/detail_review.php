...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= base_url('industri/review-kinerja/daftar') ?>" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm border-0 rounded-3 h-100">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        ...
                        <p class="fw-medium mb-0"><?= esc($review['nama_mahasiswa']) ?></p>
                    </div>
                    <div class="mb-2">
                        <span class="text-muted small">Email:</span>
                        <p class="fw-medium mb-0"><?= esc($review['email']) ?></p>
                    </div>
                    <div class="mb-0">
                        <span class="text-muted small">No HP:</span>
                        <p class="fw-medium mb-0"><?= esc($review['no_hp']) ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0 rounded-3 h-100">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        ...
                        <p class="fw-medium mb-0"><?= esc($review['nama_pembimbing_perusahaan']) ?></p>
                    </div>
                    <div class="mb-2">
                        <span class="text-muted small">Perusahaan:</span>
                        <p class="fw-medium mb-0"><?= esc($review['nama_perusahaan']) ?></p>
                    </div>
                    <div class="mb-2">
                        <span class="text-muted small">Jabatan/Divisi:</span>
                        <p class="fw-medium mb-0"><?= esc($review['jabatan']) ?> / <?= esc($review['divisi']) ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                ...
                <div class="card-body">
                    <p><?= !empty($review['saran_lulusan']) ? esc($review['saran_lulusan']) : '-' ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                ...
                <div class="card-body">
                    <p><?= !empty($review['kemampuan_teknik_dibutuhkan']) ? esc($review['kemampuan_teknik_dibutuhkan']) : '-' ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                ...
                <div class="card-body">
                    <p><?= !empty($review['profesi_cocok']) ? esc($review['profesi_cocok']) : '-' ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="text-end mt-4">
        <small class="text-muted">Tanggal Review: <?= date('d M Y, H:i', strtotime($review['created_at'])) ?></small>
    </div>
</div>
