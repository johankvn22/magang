      ...
      <div class="col-md-6 text-end">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item text-white" href="<?= site_url('mahasiswa/edit'); ?>">Profile</a></li>
            <li><a class="dropdown-item text-white" href="<?= site_url('mahasiswa/ganti-password'); ?>">Ganti Password</a></li>
