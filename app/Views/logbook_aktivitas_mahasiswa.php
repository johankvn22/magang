...
<div class="container-fluid px-2">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
   ...
   <form method="get" action="<?= site_url('admin/aktivitas') ?>" class="row mb-3">
      <div class="col-md-8">
    ...
    <form method="get" action="<?= site_url('admin/aktivitas') ?>" class="row mb-3 g-2">
    <div class="col-md-12">
          ...
          <tbody>
            <?php foreach ($mahasiswa as $index => $mhs): ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= base_url('admin/aktivitas/' . $mhs['mahasiswa_id']) ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                    Detail Aktivitas
                  </a>
                </td>
              </tr>
