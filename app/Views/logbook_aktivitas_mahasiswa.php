...
<div class="container mt-2">
  <div class="row justify-content-center">
    <div class="col-lg-12">
      ...
      <h2 class="mb-4 text-left">Monitoring Aktivitas Mahasiswa di Industri</h2>
      ...
      <div class="table-responsive">
        <table class="table table-hover align-middle" id="aktivitasTable">
          ...
          <tbody>
            <?php foreach ($mahasiswa as $mhs): ?>
              <tr>
                <td>
                  <a href="<?= base_url('admin/aktivitas/' . $mhs['mahasiswa_id']) ?>" class="btn btn-sm btn-outline-primary">Detail</a>
                </td>
