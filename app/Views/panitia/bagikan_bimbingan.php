...
<body>
    ...
    <div class="container mt-4">
        ...
        <form method="post" action="<?= base_url('/panitia/simpan-bimbingan') ?>" class="bg-light p-4 rounded shadow-sm">
            <div class="mb-3">
            ...
            <a href="<?= base_url('panitia/bagikan-bimbingan') ?>" class="btn btn-danger">Cancel</a>
        </form>
    </div>
