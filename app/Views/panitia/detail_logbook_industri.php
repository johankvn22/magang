...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= base_url('panitia/logbook-aktivitas') ?>" class="btn btn-outline-secondary">
            <i class="bi bi-arrow-left me-1"></i> Kembali
        </a>
    </div>

    <!-- Student & Pembimbing Information Card -->
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    <h6 class="mb-2 d-flex align-items-center">
                        <i class="bi bi-briefcase me-2 text-secondary"></i>Informasi Industri
                    </h6>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <p class="mb-0 fw-medium"><?= esc($mahasiswa['divisi'] ?? '-') ?></p>
                        </div>
                        <div class="col-md-6 mb-2">
                            <span class="text-muted small">Pembimbing Industri:</span>
