...
<div class="container-fluid px-2">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <form method="get" action="<?= site_url('panitia/user-requirement') ?>" class="row mb-3">
      <div class="col-md-8">
    ...
    <form method="get" action="<?= site_url('panitia/user-requirement') ?>" class="row mb-3 g-2">
      <div class="col-md-12">
          ...
          <tbody>
            <?php foreach ($mahasiswaList as $index => $mhs): ?>
              <tr>
                ...
                <td>
                  <a href="<?= site_url('panitia/user-requirement/detail/' . $mhs['mahasiswa_id']) ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                    Detail
                  </a>
                </td>
              </tr>
