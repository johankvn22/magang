                                    ...
                                    <?php foreach ($logbook as $entry): ?>
                                        <tr class="<?= $entry['status_validasi'] == 'tidak valid' ? 'table-danger-light' : '' ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                ?>
                                                <?php
                                                $status = strtolower($entry['status_validasi'] ?? ''); // tangani jika kosong
                                                $badgeClass = $statusClass[$status] ?? 'secondary'; // fallback jika status tidak dikenali
                                                ?>

                                                <span class="badge bg-<?= esc($badgeClass) ?>">
                                                    <?= esc($entry['status_validasi'] ?: 'Tidak diketahui') ?>
                                                </span>
