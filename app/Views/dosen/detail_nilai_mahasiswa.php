        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-6">
                <div class="card h-100 shadow-sm card-hover border-success">
                    ...
                    <div class="card-body">
                        <?php if ($nilaiIndustri || $penilaian): ?>
                            <div class="d-flex flex-column h-100">
                                <!-- Nilai Industri -->
                                <?php if ($nilaiIndustri): ?>
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span class="fw-bold text-success"><?= number_format($nilaiIndustri['total_nilai_industri'], 2) ?></span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($penilaian): ?>
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="text-muted">Total</span>
                                            <span class="fw-bold text-primary"><?= number_format($penilaian['total_nilai'], 2) ?></span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="mt-auto pt-3 border-top">
                                    <?php 
                                    $total_nilai = 0;
                                    if ($nilaiIndustri && $penilaian) {
                                        $total_nilai = ($nilaiIndustri['total_nilai_industri'] * 0.6) + ($penilaian['total_nilai'] * 0.4);
                                    } elseif ($nilaiIndustri) {
                                        $total_nilai = $nilaiIndustri['total_nilai_industri'];
                                    } elseif ($penilaian) {
                        ...
                        <table class="table table-bordered table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-info score-badge"><?= $nilaiIndustri['komunikasi'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>1.2 Mahasiswa mampu berpikir kritis</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-info score-badge"><?= $nilaiIndustri['berpikir_kritis'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>1.3 Mahasiswa mampu bekerja secara individu maupun tim</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-info score-badge"><?= $nilaiIndustri['kerja_tim'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>1.4 Mahasiswa memiliki daya inisiatif, kreatif, inovatif, dan adaptif yang tinggi</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-info score-badge"><?= $nilaiIndustri['inisiatif'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>1.5 Mahasiswa memiliki kemampuan literasi, informasi, media, dan teknologi</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-info score-badge"><?= $nilaiIndustri['literasi_digital'] ?></span></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-success score-badge"><?= $nilaiIndustri['deskripsi_produk'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>2.2 Mahasiswa mampu menentukan requirement/Spesifikasi produk</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-success score-badge"><?= $nilaiIndustri['spesifikasi_produk'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>2.3 Mahasiswa mampu membuat desain produk</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-success score-badge"><?= $nilaiIndustri['desain_produk'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>2.4 Mahasiswa mampu mengimplementasikan produk</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-success score-badge"><?= $nilaiIndustri['implementasi_produk'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>2.5 Mahasiswa mampu melakukan pengujian produk</td>
                                    <td class="text-center">1 - 10</td>
                                    <td class="text-center"><span class="badge bg-success score-badge"><?= $nilaiIndustri['pengujian_produk'] ?></span></td>
                                </tr>
                            </tbody>
                            <tfoot class="table-light">
                                <tr>
                                    ...
                                    <td class="text-center fw-bold fs-4">
                                        <span class="badge bg-primary total-score"><?= number_format($nilaiIndustri['total_nilai_industri'], 2) ?></span>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <table class="table table-bordered table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-info score-badge"><?= $penilaian['nilai_1_1'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">5 - 10</td>
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-info score-badge"><?= $penilaian['nilai_1_2'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">5 - 10</td>
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-info score-badge"><?= $penilaian['nilai_1_3'] ?></span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">5 - 10</td>
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-warning score-badge"><?= $penilaian['nilai_2_1'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">5 - 10</td>
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-warning score-badge"><?= $penilaian['nilai_2_2'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">5 - 10</td>
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-warning score-badge"><?= $penilaian['nilai_2_3'] ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">5 - 10</td>
                                    <td class="text-center fw-bold">
                                        <span class="badge bg-warning score-badge"><?= $penilaian['nilai_2_4'] ?></span>
                                    </td>
                                </tr>
                            ...
                            <tfoot class="table-light">
                                <tr>
                                    ...
                                    <td class="text-center fw-bold fs-4">
                                        <span class="badge bg-primary total-score"><?= $penilaian['total_nilai'] ?></span>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
